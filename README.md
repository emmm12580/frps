...
`REPO=emmm12580/frps` 由于 **fork** 到你自己的仓库,需修改`emmm12580`为你的 GitHub 账号ID.

#### 执行一键脚本
修改以下脚本链接中的`emmm12580`为你的 GitHub 账号 ID 后,执行即可.
```shell
wget https://raw.githubusercontent.com/emmm12580/frps/master/frps_linux_install.sh && chmod +x frps_linux_install.sh && ./frps_linux_install.sh
```
#### 卸载脚本
